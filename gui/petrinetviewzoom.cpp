...
PetriNetViewZoom::PetriNetViewZoom(QGraphicsView* view)
...
void PetriNetViewZoom::setModifiers(Qt::KeyboardModifiers modifiers) {
	mModifiers = modifiers;

}

void PetriNetViewZoom::setZoomFactorBase(double value) {
	mZoomFactorBase = value;
}

bool PetriNetViewZoom::eventFilter(QObject *object, QEvent *event) {
